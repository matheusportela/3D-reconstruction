...
for c=1:numel(camera)
    ...
    surface('XData', reshape(worldpix(1,:),round(h/subsample),round(w/subsample)), ...
        'YData', reshape(worldpix(2,:),round(h/subsample),round(w/subsample)), ...
        'ZData', reshape(worldpix(3,:),round(h/subsample),round(w/subsample)), ...
